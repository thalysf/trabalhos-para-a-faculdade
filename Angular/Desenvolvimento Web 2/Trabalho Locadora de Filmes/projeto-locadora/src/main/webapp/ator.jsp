...
<div>
  <form action="AtorManterController" method="POST">
    <label for="nome">Nome</label>
    <input type="text" id="nome" name="nome" placeholder="Nome do ator...">
...
<table id="atores">
  ...
  <c:forEach items="${atores}" var="ator">	
    <tr>
      <td>${ator.nome}</td>
      <td>
        <a href="<%=request.getContextPath()%>/AtorDeletarController?idAtor=${ator.idAtor}"><i class="fas fa-trash-alt"></i></a>
      </td>
    </tr>
  </c:forEach>
  </table>
